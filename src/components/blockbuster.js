...
export default function Blockbuster({overhead, title, description, image}) {
  return (
    <section className="relative flex flex-col justify-end min-h-[60vh] w-screen md:mb-0 mx-auto pt-12 md:py-20 overflow-hidden">
      ...
      <div className="w-full pt-[60%] absolute bottom-0 bg-gradient-to-t from-brand-1 via-transparent md:via-transparent to-transparent opacity-90 z-10"/>
